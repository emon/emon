/* mchip.h - Motion JPEG Chip Kawatersu LSI KL5A72002 definitions 
...
#define PCI_DEVICE_ID_KAWASAKI_MCHIP	0xff01

/* PCI configuration registers */

#define MCHIP_PCI_POWER_CSR		0x54
#define MCHIP_PCI_MCORE_STATUS		0x60            /* see HIC_STATUS   */
#define MCHIP_PCI_HOSTUSEREQ_SET	0x64            /* These are PCI    */
#define MCHIP_PCI_HOSTUSEREQ_CLR	0x68            /*   addresses that */
#define MCHIP_PCI_LOWPOWER_SET		0x6c            /*   require a pci_ */
#define MCHIP_PCI_LOWPOWER_CLR		0x70            /*   function to    */
#define MCHIP_PCI_SOFTRESET_SET		0x74            /*   use.           */
